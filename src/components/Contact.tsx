  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'batuhan.baykal@example.com',
      href: 'mailto:batuhan.baykal@example.com'
    },
    {
      icon: Phone,
      title: 'Phone',
          ...
          >
            <div>
              ...
              <p className="text-slate-400 mb-8">
                ...
                or just having a friendly conversation about technology and software development.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-4 p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition-all duration-300 group"
                >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 glow-animation"
              >
                <Send size={20} />
                Send Message
              </motion.button>
